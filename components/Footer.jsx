  ...
  return (
    <footer className="grid w-full divide-y-[1px] divide-gray-300 bg-gray-100 text-sm text-gray-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 grid-flow-row-dense px-8 py-3">
        <div className="flex justify-center items-center  gap-x-3 md:col-span-2 lg:col-span-1 lg:col-start-2">
          <BsGlobe className="text-green-700" /> Carbon Neutral since 2007
        </div>
